...
<body>
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" action="{{ route('register') }}" method="POST">
            ...
            <div class="form-field d-flex align-items-center"> <span class="fas fa-envelope"></span> <input type="email" name="email" id="email" placeholder="Email"> </div>
            ...
            <div class="form-field d-flex align-items-center"> <span class="fas fa-key"></span> <input type="password" name="password_confirmation" id="password-confirm" placeholder="Repeat Password"> </div> 
            <button class="btn mt-3" type="submit">Register</button>
        </form>
        <div class="text-center fs-6">Already have an account? <a href="/">Sign in</a> </div>
    </div>
</body>
</html>