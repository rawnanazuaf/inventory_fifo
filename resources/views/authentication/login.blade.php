...
<body>
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" action="{{ route('login') }}" method="POST">
            @csrf
            <div class="form-field d-flex align-items-center"> <span class="fas fa-envelope"></span> <input type="email" name="email" id="pwd" placeholder="Email"> </div>
        ...
        <div class="text-center fs-6"><a href="/registerUser">Sign up</a> </div>
    </div>
</body>
</html>